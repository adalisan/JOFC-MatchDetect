...
\includegraphics{graphs/FidCommPaper-wiki-2cond-plot}
...
\includegraphics{graphs/FidCommPaper-fig-stats-d}
The plot here shows the effect of $d$ on Fidelity and Commensurability errors.


\includegraphics{graphs/FidCommPaper-FidComm-d-plot-Gaussian-2}

\includegraphics{graphs/FidCommPaper-FidComm-d-plot-Gaussian-3}
