...
\begin{proof}
 Set $z_n=T(s)$. Since $T(w)$ is continuous in probability, conditions for \ref{lemma_1} hold, i.e. as $s\rightarrow w_0$, $z_n$ converges in probability to $z=T(w_0)$. By \ref{lemma_1}, we conclude  g(z_n;\gamma) Pr \left[ T(w) \geq 0\right]$  is continuous with respect to $z_n$.
\begin{comment}
